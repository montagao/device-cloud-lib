/* deviceCloudTelemetryRtpCfg.c - Device Cloud configlette */
...
#define DEVICE_CLOUD_TELEMETRY_RTP_NAME "iot-app-simple-telemetry"
...
static void deviceCloudTelemetryRtpDelay (void)
    ...
    if ((fd = open (DEVICE_CLOUD_TELEMETRY_RTP_NAME, O_RDONLY, 0)) == -1)
        {
...
/******************************************************************************
* 
* deviceCloudTelemetryRtp() - spawns a task
*
